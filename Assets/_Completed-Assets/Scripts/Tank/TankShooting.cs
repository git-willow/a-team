...
namespace Complete
{
    public class TankShooting : MonoBehaviour
    {
        ...
        // 追加
        public int initialAmmo = 10; // ゲーム開始時の弾数
        public int maxAmmo = 50; // 最大ストック数
        public int currentAmmo; // 現在の弾数
        public int ammoPerCartridge = 10; // カートリッジで補充される弾数(10とする)

        // 砲弾の所持数が変化した時に発生するイベント
        ...
        private void Fire()
        {
            ...
            // 所持数が変化した時にイベントを発火
            OnShellStockChanged?.Invoke(currentAmmo);
        ...
        {
            // 衝突したオブジェクトがShellCartridgeタグを持つ場合
